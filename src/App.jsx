...
function ProductIcon({ product, className = "emoji" }) {
...
function ProductGrid({ products, isLoading, wishlist, onAddToCart, onToggleWishlist, emptyMessage = "No products found." }) {
